...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('/cart/{id}', [OrderController::class,'cartItemDetail'])->name('api.cartItemDetail');

    Route::post("/remove-cart", [OrderController::class,'removeItemCart'])->name('api.removeItemCart');

    Route::post("/remove-all-cart",[OrderController::class,'removeAllCart'])->name('api.removeAllCart');
