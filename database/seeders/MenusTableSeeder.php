    ...
    public function run()
    {
        ...
        $menuItems = [
            [
                "id" => 1,
                "title" => "تحویل اکسپرس",
                "icon" => "fa-regular fa-box tw-text-amber-500",
            ],
            [
                "id" => 2,
                "title" => "خرید آنلاین مطمئن",
                "icon" => "fa-regular fa-credit-card tw-text-emerald-500",
            ],
            [
                "id" => 3,
                "title" => " تضمین اصالت کالا",
                "icon" => "fa-regular fa-badge-check tw-text-purple-500",
            ],
            [
                "id" => 4,
                "title" => "مشاور رایگان خرید",
                "icon" => "fa-regular fa-person-dolly-empty tw-text-sky-500",
            ],
            [
                "id" => 5,
                "title" => "ضمانت بازگشت",
                "icon" => "fa-regular fa-headphones-simple tw-text-rose-500",
            ],
        ];
