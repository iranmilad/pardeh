        ...
        <div class="tw-mr-3">
            ...
            <div class="row tw-mt-6">
                <div class="col-12 tw-text-sm">
                    <span class="tw-text-gray-500">قیمت: <span class="tw-text-gray-900">{{ number_format($price) }}</span></span>
                </div>
                <div class="col-12 tw-text-sm">
                    <span class="tw-text-gray-500">قیمت با تخفیف: <span class="tw-text-gray-900">{{ number_format($sale_price) }}</span></span>
                </div>
                <div class="col-12 tw-text-sm">
                    <span class="badge tw-bg-[var(--sale-badge)]  tw-px-2 rounded-pill">تخفیف: {{ $discountPercentage }}</span>
                </div>
            </div>
        </div>
    </div>
