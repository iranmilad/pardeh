...
<head>
    ...
    <!-- Header Start -->
    @if (isset($codeMap['header_start']))
        {!! implode('', $codeMap['header_start']) !!}
    @endif
    ...
    <!-- Header End -->
    @if (isset($codeMap['header_end']))
        {!! implode('', $codeMap['header_end']) !!}
    @endif
...
<body>
    <!-- Body Start -->
    @if (isset($codeMap['body_start']))
        {!! implode('', $codeMap['body_start']) !!}
    @endif
    ...
    <!-- Footer Start -->
    @if (isset($codeMap['footer_start']))
        {!! implode('', $codeMap['footer_start']) !!}
    @endif

    @include('partials.footer')

    @if (isset($codeMap['footer_end']))
        {!! implode('', $codeMap['footer_end']) !!}
    @endif
    <!-- Footer End -->
    @livewireScripts
    ...
    <!-- Body End -->
    @if (isset($codeMap['body_end']))
        {!! implode('', $codeMap['body_end']) !!}
    @endif
