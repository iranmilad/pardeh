<header class="tw-py-4">
    <div class="container">
        <div class="tw-flex tw-items-center tw-justify-between tw-h-20">
            <img class="navbar-logo" src="{{ Vite::asset('resources/images/logo.svg') }}" alt="">
            <form class="main-search">
                <input type="text" placeholder="جستجوی محصول یا دسته بندی">
...
<div class="">
    <div class="container tw-py-4 tw-bg-[#EBEDF06B] tw-rounded-b-2xl">
        <nav class="tw-flex tw-items-center tw-justify-center navbar-link-main">
